...
Questa crescita significativa è, ovviamente, strettamente legata a diversi fattori, tra cui:
...
Inizieremo sottolineando l'importanza di unire le persone intorno a Bitcoin, sia attraverso community online che attraverso incontri di persona. Scoprirai perché e dove lanciare la tua community e come fissare obiettivi chiari per favorirne la crescita e la sostenibilità a lungo termine.



**Sezione 2: Progettare un'identità unica per la tua community Bitcoin**


Per attirare nuovi membri e promuovere un senso di appartenenza, è essenziale costruire un'identità unica. In questa sezione imparerai come progettare loghi, poster e banner che incarnino lo spirito della tua community Bitcoin.



**Sezione 3: Creare canali di comunicazione per la tua community Bitcoin**
...
**Sezione 4: Aprire i tuoi account social**
...
La sezione finale è incentrata sull'essenza del progetto: unire gli appassionati di Bitcoin attorno a una visione condivisa. Imparerai come strutturare il tuo approccio per attrarre e mantenere i membri, delegare efficacemente i compiti e far crescere la tua community in modo sostenibile.
...
- Costruzione peer-to-peer: Molte iniziative e progetti sono concepiti, costruiti e sviluppati all'interno di queste community.
...
In altre parole, **una community non ha bisogno di incontri fisici per prosperare o lanciare progetti. Il suo scopo principale rimane lo stesso: condividere, costruire ed educare**.
...
Molte di queste possibilità saranno trattate in dettaglio nella parte 6/8 di questo corso, intitolata "[Esempi di progetti e iniziative](https://planb.academy/courses/1c643dc9-a15f-4f9e-93b6-cb3c58b4ee35/3213d87a-1998-5972-ab93-97a5769ba279).



Mentre ogni community è libera di formare le proprie opinioni, lanciare progetti e sperimentare a modo suo, i meetup si stanno rivelando sempre più **essenziali per lo sviluppo di Bitcoin e per la crescita dei Bitcoiners**. **Organizzarli richiede tempo e impegno**, ed è per questo che questo corso condivide l'esperienza combinata di [circa sessanta community Bitcoin in Francia e Belgio](https://btcmap.org/communities/map#2/5.24949/0.20000) **per aiutarti a costruire e far crescere la tua community e i tuoi meetup nel modo più semplice possibile**.
...
Il tuo primo evento sarà probabilmente un meet-up. Il suo scopo principale è quello di riunire i Bitcoiners della tua zona.
...
Sii pronto: **costruire una community richiede impegno**
...
- Francia: La maggior parte delle oltre 60 community locali usa nomi come "Bitcoin [CITY]" o "[CITY] Bitcoin". I loro gruppi Telegram seguono spesso questo schema: "Bitcoin [CITTA'] meetup".
...
Per darti qualche idea, ecco alcuni esempi di loghi di community francesi:
...
Per darti un'idea più chiara, abbiamo incluso un video tutorial parziale che illustra alcune di queste possibilità:
...
Ecco alcuni modelli di Canva già pronti che puoi duplicare e adattare alla tua community:
...
Le possibilità sono infinite e i progetti dipenderanno dai tuoi obiettivi e dalla tua identità visiva. Considera la possibilità di condividere i tuoi modelli open source, per risparmiare tempo ad altre community Bitcoin che inevitabilmente affronteranno le vostre stesse sfide. Condividendo, contribuite ad accelerare la crescita delle community Bitcoin ovunque.
...
Canva offre un'ampia gamma di strumenti per creare loghi, poster, banner e volantini, ma non è l'unica opzione. Se ti senti più a tuo agio con altri software (come Photoshop o Illustrator), sentiti libero di usare quello che funziona meglio per te.


Detto questo, che si tratti di progettare il logo di una community o di migliorare poster, presentazioni o volantini, **l'intelligenza artificiale può essere un potente alleato per creare immagini uniche e accattivanti**.
...
**Esempio: Creazione di un logo futuristico per Bitcoin Londra**

Se vuoi progettare un logo futuristico per un incontro "Bitcoin London", puoi chiedere a Copilot:



- [*Prompt: Crea un logo Bitcoin con il London Bridge e il Big Ben sullo sfondo. Futuristico* - [Link](https://copilot.microsoft.com/images/create/un-logo-Bitcoin-futuriste-avec-en-arric3a8re-plan-le-/1-6612ba1758df4384bc33c4bca00ab45b?FORM=SYDBIC)
...
Se i primi quattro risultati non sono abbastanza realistici, perfeziona la richiesta:
...
- [ ] *Prompt: Crea il logo del "London Bitcoin Meetup" con uno stile britannico e pulito* - [Link](https://copilot.microsoft.com/images/create/logo-for-27londres-Bitcoin-meetup27-with-a-british-a/1-6612bb9451924859a6c34b350b3a6ebc?FORM=SYDBIC)
...
- Sii paziente: L'intelligenza artificiale potrebbe non produrre esattamente ciò che hai immaginato al primo tentativo.



- Utilizza indicazioni precise: Più le istruzioni sono chiare e dettagliate, migliori saranno i risultati.



- Chiedi aiuto: Se non sei soddisfatto, rivolgiti a qualcuno esperto di design grafico o di strumenti di intelligenza artificiale: molti Bitcoiners saranno felici di aiutarvi, a volte anche gratuitamente o con pochi Sats.



# Creazione di canali di comunicazione per la community Bitcoin
...
Come già detto, i canali di comunicazione di una community possono variare a seconda delle motivazioni e delle abitudini.


Ad esempio, **in Francia, Germania e Italia, Telegram e Twitter sono le piattaforme dominanti**, e sono diventate lo "standard" per le community Bitcoin.

Nella Repubblica Ceca, invece, molte community utilizzano **Matrix**, un protocollo di messaggistica istantanea sicuro, invece di Telegram.


Suggerimento: prima di scegliere i canali, **guardate cosa fanno le community vicine**. Utilizzate la mappa [btcmap.org](https://btcmap.org/communities/map#0/0/0/) per vedere quali piattaforme sono più popolari nella tua regione.


Ad esempio, le community svizzere utilizzano principalmente Telegram, Twitter e il proprio sito web:
...
**Canali raccomandati per le community francofone**
...
Chiunque voglia lanciare una community in Francia farebbe quindi bene a iniziare con la creazione:
...
Man mano che la tua community cresce, puoi aggiungere altre piattaforme e delegare la moderazione a membri fidati.
...
Prima di creare lo spazio di comunicazione della tua community su Telegram, è importante conoscere la differenza tra:
...
Per le esercitazioni che seguono, abbiamo inizialmente utilizzato l'APK "Telegram+", che consente una configurazione più avanzata. Tuttavia, non ne avrai necessariamente bisogno, poiché l'app ufficiale di Telegram è sufficiente per creare e gestire i gruppi, anche attraverso il tuo telefono:
...
Se vuoi creare un luogo in cui i tuoi membri possano parlarsi direttamente, rispondersi l'un l'altro e così via, allora ti conviene creare un gruppo Telegram e non un canale Telegram!


Passa direttamente alla sezione successiva, intitolata [Crea un gruppo Telegram](https://planb.academy/courses/1c643dc9-a15f-4f9e-93b6-cb3c58b4ee35/d13714ce-8f08-53e9-bedd-b6a3aaac5dad).
...
**Poiché le community hanno bisogno di interazione e collaborazione, un canale Telegram non è consigliato** se il vostro obiettivo è costruire relazioni e condividere conoscenze.
...
D'altra parte, **un Gruppo Telegram è ideale per le community**: Proprio come le applicazioni di messaggistica come Messenger o WhatsApp, i membri possono chattare e rispondersi a vicenda in un'unica conversazione condivisa.
...
- Creare **sondaggi** (utili per decidere le date degli incontri quando la community è nuova).
...
- Aggiungete un'immagine del profilo (il logo della tua community) e aggiornate il nome del gruppo.
...
Nota: questo tutorial è stato realizzato con Telegram+, ma potrai fare tutto direttamente dall'app mobile standard di Telegram.
...
Quando il tuo gruppo Telegram cresce fino a centinaia di membri, le conversazioni possono diventare caotiche. Questo spesso porta i membri a perdere annunci importanti, come la data del prossimo incontro.


Sono disponibili diverse soluzioni:


1. **Appunta i messaggi importanti** in modo che tutti i membri ricevano una notifica (premi una volta con il dito sul messaggio in questione, quindi seleziona "Pin");


2. Considera l'utilizzo di **Discord** per più canali di comunicazione, ognuno dei quali può essere disattivato se necessario.


3. **Converti il gruppo Telegram in un supergruppo**.
...
Suggerimento: Adatta gli argomenti alle esigenze della tua community. Esempio: Il meet-up Bitcoin di Abidjan utilizza con successo questo formato.
...
Tieni presente che i **supergruppi di Telegram possono essere un po' complicati da usare per alcuni membri**. Ad esempio, non tutti sanno **come accedere ai diversi argomenti** (basta toccare il logo del gruppo nel menu principale di Telegram per vedere l'elenco completo degli argomenti). L'invio di un rapido screenshot può aiutare a chiarire qualsiasi confusione.


Non c'è una regola precisa su quando passare da un gruppo Telegram normale a un supergruppo, dipende dalle esigenze dei membri. La buona notizia è che puoi passare facilmente da un gruppo all'altro: basta creare un argomento per convertirlo in un supergruppo o eliminare tutti gli argomenti tranne "Generale" per tornare a un gruppo normale.
...
Nota rapida: come accennato in precedenza, l'esercitazione di cui sopra è stata realizzata su un computer utilizzando l'APK di "Telegram+". Oggi, tuttavia, creare un supergruppo Telegram sul tuo telefono è semplice.


Basta creare un gruppo Telegram, andare nelle impostazioni e toccare il pulsante "Argomenti" per aggiungere argomenti. Una volta salvato, vedrai un elenco di argomenti che potrai modificare a tuo piacimento.


Quindi, non c'è più bisogno di scaricare "Telegram+", a meno che tu non voglia accedere a impostazioni di privacy più avanzate per il tuo supergruppo.
...
Ora che il tuo gruppo (o supergruppo) di Telegram è attivo e funzionante, è il momento di **configurare i permessi e impostare la moderazione**.

Ogni community è libera di scegliere il proprio approccio, ma l'esperienza dimostra che è **migliore limitare alcuni permessi dei membri**:
...
- Un comando **regole** (/regole) per visualizzare le linee guida della community;
...
- Elencare le reti sociali della **community** (/networks)
...
1/ **la @ Twitter**, che definisce la tua identità e ti rende facilmente reperibile. Se il nome della tua community è "Bitcoin [CITTA']", è opportuno scegliere "@Bitcoin[CITTA']";
...
Inoltre, **è possibile aggiungere un tweet o una discussione al proprio profilo Twitter per dargli la massima visibilità**, proprio come fa la community Bitcoin Witsand in Sudafrica.
...
Fai attenzione... postare per sbaglio una foto di una festa dall'account della community può accadere più velocemente di quanto pensi!


Infine, anche se il nome utente "@Bitcoin[CITY]" è unico e ormai tuo, è bene prevedere account falsi o imitatori. Considera anche la possibilità di registrare:
...
Anche se ad alcuni può sembrare banale, **seguire gli account delle community e delle iniziative locali può portare a collaborazioni o addirittura a partnership**. Ad esempio, le community Bitcoin Liegi e Bitcoin Lille (e allo stesso modo Bitcoin Aix e Bitcoin Marsiglia) si sono collegate in questo modo, arrivando a organizzare un meetup annuale.
...
Come già detto, l'obiettivo di seguirsi a vicenda è quello di aumentare la visibilità reciproca. Più promuovi la tua community e quelle della tua regione/paese sui social network, più le persone parleranno di te. Più le persone parleranno di te, più sarà probabile che partecipino ai tuoi eventi.
...
Anche altre piattaforme possono aumentare la tua visibilità. **[Meetup](https://www.meetup.com/)** è una di queste, ed è un sito web (e un'applicazione per telefono) dove è possibile creare un evento e trovare altre persone nelle vicinanze.
...
Naturalmente, più grandi sono gli obiettivi di sviluppo della community, più tempo tu e i tuoi membri dovrete investire.
...
Puoi lanciare un meet-up poche settimane dopo aver creato la tua community.
...
Piuttosto che scegliere la data da soli, di solito è meglio **creare un sondaggio una decina di giorni prima con diversi giorni e orari possibili**. In questo modo, potrai utilizzare i voti per massimizzare la partecipazione, creare entusiasmo e utilizzare al meglio il vostro tempo.
...
Dopo il primo incontro, probabilmente vorrete organizzarne un altro. Finché la tua community è ancora piccola, è meglio scegliere le date tramite sondaggi, ad esempio una volta al mese o ogni due mesi. Puoi discuterne nei tuoi canali di comunicazione.
...
2) aiuta a **stabilire un'"abitudine "**. Anche se qualcuno smette di controllare regolarmente i tuoi canali, saprà comunque quando si terrà l'incontro e potrà presentarsi, come al solito.
...
Trovare una sede per i tuoi eventi spesso non è un compito facile. Inoltre, è essenziale che questa sede sia **localizzata nella città della tua community**.
...
In seguito, quando il tuo gruppo sarà cresciuto, potresti anche dedicare un pomeriggio a visitare diversi esercizi commerciali e bar, chiedendo se hanno uno spazio adatto a ospitare i tuoi eventi e incontri mensili.
...
2/ **Annunciare l'evento**:
    ...
    - Condividi la data, l'ora e il luogo sui tuoi social network e altri canali di comunicazione. Se necessario, includi un link per la registrazione.
    - Crea un visual dedicato (ad esempio un poster Canva, vedi parte 2/8 "[Progettare un'identità per la tua community Bitcoin](https://planb.academy/courses/1c643dc9-a15f-4f9e-93b6-cb3c58b4ee35/b48a18cc-afdf-5216-802c-32647b5cd8a3)").
...
Due o tre giorni prima dell'evento, condividi e ritwitta i tuoi annunci per aumentare la visibilità.
...
Se ti aspetti solo pochi partecipanti e non hai ancora instaurato un rapporto con i gestori della sede, evita di portare ed esporre subito tutta l'attrezzatura. Una volta instaurata la fiducia, avrai più libertà di organizzare lo spazio come desideri.


Infine, prendi un drink e aspetta che le persone arrivino. E ricorda: non scoraggiarti se la prima volta non arriva nessuno. Porta con te un libro o un video da guardare, non si sa mai.
...
Ulteriori materiali modificabili si trovano anche nel [Bitcoin Teaching Toolbox](https://planb.academy/fr/resources/bet)!
...
E molto altro ancora, l'unico limite è la tua immaginazione!
...
In base alla tua disponibilità e al livello di coinvolgimento nella tua community, puoi pianificare altri eventi nel corso dell'anno, ad esempio:
...
Gli adesivi sono un modo divertente per promuovere Bitcoin e la tua community, rafforzando al contempo la tua identità.
...
Per sostenere l'ecosistema, la **[casa editrice Konsensus Network](https://konsensus.network/) offre ai meet-up e alle community internazionali del Bitcoin uno sconto dal 15% al 35% su tutti i suoi libri dalla fine del 2023, per ordini di tre o più libri**.
...
Se non hai i fondi necessari, puoi comunque trasferire lo sconto ai tuoi soci. Ad esempio, un organizzatore potrebbe raccogliere gli ordini dei soci, fare un ordine in blocco a prezzo ridotto e distribuire i libri al prossimo incontro, con il pagamento in un'unica soluzione.


Potresti anche esporre una carta del prestito di libri durante i tuoi incontri per spiegare chiaramente le regole del prestito ai nuovi arrivati.


Ecco un esempio open-source che puoi utilizzare e adattare:
...
Diversi volantini sono già **disponibili open-source nel [Bitcoin Teaching Toolbox](https://planb.academy/fr/resources/bet)** su planB.network e altri saranno aggiunti nel tempo.
...
Per la maggior parte delle community, questo prezzo è proibitivo, soprattutto perché il documentario è già disponibile gratuitamente sul canale YouTube di ARTE.
...
## Affissione di manifesti nella tua città
...
Ad esempio, nel 2023, l'associazione francese [Bitcoin Lille](https://twitter.com/BitcoinLille) ha ordinato un lotto di tessere NFC con un design personalizzato. Ogni nuovo membro ne ha ricevuta una nel suo pacchetto di benvenuto durante l'anno. Questa idea può essere facilmente adattata e personalizzata per la tua community.
...
Sebbene esistano altre piattaforme CMS(content management system), alcune con interfacce più semplici e adatte ai principianti, di solito sono molto meno personalizzabili. Ecco perché WordPress è generalmente il miglior punto di partenza.
...
Per l'intro e l'outro del tuo **video**, puoi trovare facilmente dei modelli adatti su Canva. Personalizza il design secondo i tuoi gusti, scaricalo e aggiungilo al tuo software di editing.


Suggerimento: se Bitcoin dovesse essere vietato o censurato, conserva sempre un backup locale dei tuoi video su un hard disk.
...
Ogni piattaforma ha il suo pubblico, quindi essere presenti su più piattaforme amplierà la tua portata. **[Spotify per podcaster](https://podcasters.spotify.com/) semplifica questo aspetto, consentendoti di caricare il tuo podcast una volta sola e genera un feed RSS per le altre piattaforme**.
...
## Crea un badge per i tuoi eventi
...
Anche se un po' formale, questo può aiutare i membri a trovare più facilmente interessi comuni e argomenti di conversazione, e rende anche più facile per i nuovi arrivati individuare gli organizzatori (o i membri ufficiali della community/associazione).
...
Su una nota completamente diversa, affrontiamo un argomento delicato: la scomparsa di un membro della tua community Bitcoin .


Un giorno potreste essere contattati dalla famiglia di un ex socio per informarvi della sua morte. Potrebbero spiegarvi che il defunto ha lasciato delle istruzioni, tra cui quella di mettersi in contatto con la tua community, ritrovo o associazione.


In alcuni casi, la famiglia può anche chiedere aiuto per recuperare i fondi come beneficiari dell'eredità.


È saggio collaborare con la community per stabilire in anticipo una procedura chiara per queste situazioni, assicurando che:
...
L'elenco dei progetti descritti sopra non è ovviamente esaustivo. In generale, è più probabile che si tratti di progetti interni alla community o ai meetup, che possono essere implementati abbastanza facilmente man mano che si sviluppano.


Passiamo ora all'onboarding.


Come sai, uno dei modi migliori **per raggiungere un vasto pubblico in una sola volta è quello di tenere una conferenza gratuita**. Questo può essere fatto nei college e nelle università, introducendo sia i giovani (che i meno giovani) a Bitcoin, sia che si tratti di persone completamente nuove o che vogliano approfondire la loro conoscenza.
...
Altrettanto importante è **mantenere una mente aperta e sapere quando semplificare i concetti**, soprattutto durante la sessione di domande e risposte o una tavola rotonda. Non si tratta di rinunciare ai propri principi, ma solo di riconoscere che gli altri potrebbero vedere le cose in modo diverso. A volte è meglio rispondere più tardi o lasciar perdere, in modo che la discussione possa continuare. Se le tue argomentazioni sono solide e ben documentate, le persone lo riconosceranno.
...
- Ex professori della tua scuola di ingegneria o università
...
Se ti chiedono che cos'è Bitcoin, sii breve e privo di gergo. Per esempio:
...
Quindi consegna loro un volantino, come "21 ragioni per utilizzare Bitcoin" o "10 ragioni per accettare Bitcoin nella tua azienda", con le tue informazioni di contatto o i dettagli del tuo incontro. In questo modo, quando saranno pronti per una dimostrazione, sapranno dove trovarti.
...
Un'ottima opzione è **[Swiss Bitcoin Pay](https://swiss-Bitcoin-pay.ch/)**, perché:
    ...
    - Offre ai dipendenti un'interfaccia intuitiva per accettare i pagamenti senza toccare la cassa.
...
Dopo che sono saliti a bordo:
    ...
    - Visita regolarmente e fai acquisti.
...
Il primo, il più facile da prevedere, è l'aumento del numero di persone che si uniscono alla tua community. Questo ti influenzerà in due modi principali:
...
## Un piano d'azione rapido per costruire la tua community Bitcoin
...
Come hai visto in questo corso, **costruire una community Bitcoin e organizzare incontri** richiede pianificazione e motivazione. A seconda dei tuoi obiettivi e del tempo che puoi dedicare, potresti intraprendere progetti più ambiziosi o mantenere le cose semplici.
